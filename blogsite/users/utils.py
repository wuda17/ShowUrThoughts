...
def save_picture(form_picture):
    ...
    #Resizing images for performance using Pillow package (PIL)
    output_size = (125, 125)
...
#Automated email for token for password reset.
def send_reset_email(user):
    token = user.get_reset_token()
    msg = Message('Pass Reset Request for Your ShowurThoughts Account', 
